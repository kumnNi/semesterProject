          ...
          <Col md={10} lg={8} xs={12}>
            ...
            >
              ...
              <div className="row">
                <div className="col-md-6 mb-4">
                  <div className="form-outline">
                    <label className="form-label">Application User Name</label>
                  </div>
                </div>
                <div className="col-md-6 mb-4">
                  <div className="form-outline">
                    <input
                      ...
                      value={bewerbung.applicantFirstName}
              ...
              <div className="row">
                <div className="col-md-6 mb-4">
                  <div className="form-outline">
                    <label className="form-label">DegreeCourse Detail</label>
                  </div>
                </div>
                <div className="col-md-6 mb-4">
                  <div className="form-outline">
                    ...
                    <input
                      ...
                      name="displayedName"
                      value={`${bewerbung.departmentName}: ${bewerbung.departmentShortName} `}
                      placeholder=""
                      className="form-control form-control-lg"
                      readOnly
                    />
